...
class uiCanvas(tk.Canvas):
    def __init__(self, **kwargs):
        ...
        # object sprites
        self.tank = tk.PhotoImage(file="images/bot2.png")
        self.rTankSprite = tk.PhotoImage(file="images/red_up1.png")
        self.bTankSprite = tk.PhotoImage(file="images/blue_up1.png")
        self.gTankSprite = tk.PhotoImage(file="images/green_up1.png")
        self.player = tk.PhotoImage(file="images/stick.png")
        self.boxSprite = tk.PhotoImage(file="images/barrel_top.png")

        # item sprites
        self.red_flag = tk.PhotoImage(file="images/redFlag.png")
        self.blue_flag = tk.PhotoImage(file="images/blueFlag.png")
    ...
    def drawObj(self, **kwargs):
        ...
        elif dd["text"] == "L":  # L is used for blue because B is already used for box
...
class uiCanvas(tk.Canvas):
    ...
    def drawObj(self, **kwargs):
        ...
        # sample = tk.PhotoImage(file="boatGig.gif")
        # return self.create_image(x, y, image=tk.BitmapImage(file="hpaint.bmp"))
        # img = tk.PhotoImage(file="Twitter Boat 23.png")

        img = tk.PhotoImage(file="Scrabble Tiles\PNGs\L.png")

        print(x, "-", y)

        # return self.create_image(x, y, anchor="nw", image=img)
        # return self.create_bitmap(x, y, bitmap="error")
    ...
    def drawItem(self, **kwargs):
        dd = kwargs["dd"]
        x = (
            dd["x"] * self.cell_size  # how many cells deep you are
            + self.obj_char_size / 2  # center in middle of cell
            + self.char_offset  # particular to character; fine adjustments
            + self.cell_size  # add one more cell to account for border cells
        )
        y = (
            dd["y"] * self.cell_size
            + self.obj_char_size / 2
        ...
        mine = tk.PhotoImage(file="bigboy.gif")
        print(mine)

        # if self.create_image(x, y, image=mine, anchor="center"):
        #  print(self.create_image(x, y, image=mine, anchor="center"))

        # self.create_image(x, y, image=mine)
